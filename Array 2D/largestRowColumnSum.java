...
Then the test cases follow. First line of each test case or query contains two integer values, 'N' and 'M',
...
public class largestRowColumnSum {
    ...
    public static void findLargest(int[][] mat) {
        ...
        if (largestRowSum >= largestColSum) {
            System.out.println("row" + " " + rowCount + " " + largestRowSum);
        } else {
            System.out.println("col" + " " + colCount + " " + largestColSum);
        }
    }
}