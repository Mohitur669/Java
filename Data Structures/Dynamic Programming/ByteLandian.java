...
Output format :
Print the maximum amount of American dollars you can make.
...
public class ByteLandian {
    ...
    public static long byteLandianDP(long n, HashMap<Long, Long> memo) {
        ...
        if (!memo.containsKey(n)) {
            long ans1 = byteLandianDP(n / 2, memo);
            long ans2 = byteLandianDP(n / 3, memo);
            long ans3 = byteLandianDP(n / 4, memo);
