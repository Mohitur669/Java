/*
You need to implement a class for Dequeue i.e. for double ended queue. I
n this queue, elements can be inserted and deleted from both the ends.
...
public class DoubleEndedQueue {
    public static void main(String[] args) {
        Scanner s = new Scanner(System.in);
        DoubleEndedQueue dq = new DoubleEndedQueue(10);
        while (true) {
            int choice = s.nextInt(), input;
            switch (choice) {
                case 1:
